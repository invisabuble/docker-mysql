...
COPY ./docker-apache/web/private/certs/mysql-server.key /etc/mysql/certs/mysql.key
COPY ./docker-apache/web/private/certs/mysql-server.crt /etc/mysql/certs/mysql.crt
